...
export const metadata: Metadata = {
  title: "Smile and Eat - Fine Dining Restaurant",
  description: "Experience culinary excellence at Smile and Eat. Fresh ingredients, innovative cuisine, and warm hospitality. Reserve your table today.",
  keywords: "restaurant, dining, fine dining, fresh cuisine, local ingredients",
  metadataBase: new URL("https://smileandeat.com"),
  alternates: {
    canonical: "https://smileandeat.com"
  },
  openGraph: {
    title: "Smile and Eat - Fine Dining Restaurant",
    description: "Experience culinary excellence with our signature dishes and warm atmosphere",
    siteName: "Smile and Eat",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765795303919-s0u1vzsy.jpg",
        alt: "Smile and Eat Restaurant"
      }
    ]
  },
  twitter: {
    ...
    title: "Smile and Eat - Fine Dining Restaurant",
    description: "Discover exceptional dining experiences at Smile and Eat",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765795303919-s0u1vzsy.jpg"]
  },
  robots: {
    index: true,
    follow: true
